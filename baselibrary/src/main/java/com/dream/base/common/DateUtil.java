...
public class DateUtil {
     ...
     * @return
     */
    public static String getShowTimeLikeWeChatInChat(long timestamp) {
        Date date = new Date(timestamp);
        return formatDateTimeInChat(date);
    }
     ...
     * @return
     */
    private static String formatDateTimeInChat(Date date) {
        ...
        if (current.after(today)) {
            ...
            format = new java.text.SimpleDateFormat("MM月dd日 HH:mm");
            return format.format(date);
        }
    }
